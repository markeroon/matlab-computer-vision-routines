function [phi,d_mag,kappa,nabla_dnabla_phi,dphidt] = convect2d( phi, d,delta_t, n_iters,...
    ...
    for i = 1:n_iters
        ...
        %dt = get_dt_normal(delta_t, dx, dy, H1_abs, H2_abs);
        
        %dphidt = d.*phi;  % this would never move -- phi == 0, DUHH!
        %phi = phi + dphidt * delta_t;
        
        dphidt = grad_weight*nabla_dnabla_phi + curvature_weight*d_mag.*kappa;
