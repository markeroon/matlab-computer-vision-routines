...
function [X__,Y__,Z__] = registerPoints( X,Y,opt,MIN_SIZE )   
    if size(X,1) > MIN_SIZE && size(Y,1) > MIN_SIZE
        ...
        k = 10;
        max_dist = 7;
        Y_ur_000 = findPointstoRegister( Y,X(idx_x_000,:),k,max_dist )
        Y_ur_001 = findPointstoRegister( Y,X(idx_x_001,:),k,max_dist )
        Y_ur_010 = findPointstoRegister( Y,X(idx_x_010,:),k,max_dist )        
        Y_ur_011 = findPointstoRegister( Y,X(idx_x_011,:),k,max_dist )        
        Y_ur_100 = findPointstoRegister( Y,X(idx_x_100,:),k,max_dist )        
        Y_ur_101 = findPointstoRegister( Y,X(idx_x_101,:),k,max_dist )        
        Y_ur_110 = findPointstoRegister( Y,X(idx_x_110,:),k,max_dist )
        Y_ur_111 = findPointstoRegister( Y,X(idx_x_111,:),k,max_dist )        
        ...
        [Y1_000,Y2_000,Y3_000] = registerPoints( X(idx_x_000,:),Y_ur_000,opt,MIN_SIZE );
        %idx_x_000 = 0; idx_y_000 = 0;
        [Y1_001,Y2_001,Y3_001] = registerPoints( X(idx_x_001,:),Y_ur_001,opt,MIN_SIZE );
        %idx_x_001 = 0; idx_y_001 = 0;
        [Y1_010,Y2_010,Y3_010] = registerPoints( X(idx_x_010,:),Y_ur_010,opt,MIN_SIZE );
        %idx_x_010 = 0; idx_y_010 = 0;
        [Y1_011,Y2_011,Y3_011] = registerPoints( X(idx_x_011,:),Y_ur_011,opt,MIN_SIZE );
        %idx_x_011 = 0; idx_y_011 = 0;
        [Y1_100,Y2_100,Y3_100] = registerPoints( X(idx_x_100,:),Y_ur_100,opt,MIN_SIZE );
        %idx_x_100 = 0; idx_y_100 = 0;
        [Y1_101,Y2_101,Y3_101] = registerPoints( X(idx_x_101,:),Y_ur_101,opt,MIN_SIZE );
        %idx_x_101 = 0; idx_y_101 = 0;
        [Y1_110,Y2_110,Y3_110] = registerPoints( X(idx_x_110,:),Y_ur_110,opt,MIN_SIZE );
        %idx_x_110 = 0; idx_y_110 = 0;
        [Y1_111,Y2_111,Y3_111] = registerPoints( X(idx_x_111,:),Y_ur_111,opt,MIN_SIZE );
