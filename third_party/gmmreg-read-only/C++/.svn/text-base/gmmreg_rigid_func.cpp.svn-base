...
//    std::cout << "f begin" << std::endl;
 ...
 //   std::cout << "transform done" << std::endl;
    double energy = GaussTransform(gmmreg->transformed_model, gmmreg->scene, scale, gradient);
...
void gmmreg_rigid_func::gradf(const vnl_vector<double>& x, vnl_vector<double>& g)
{
/*     case 'rigid2d'
