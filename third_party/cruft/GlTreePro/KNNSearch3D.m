% KNNSearch3D query a GL-tree for k nearest neighbor(kNN)
%
% SYNTAX
%
% [kNNG]=KNNSearch3D(p,qp,ptrtree,k);       short
% [kNNG,Dist]=KNNSearch3D(p,qp,ptrtree,k);  long
%
% INPUT PARAMETERS
% 
%       p: [3xN] double array coordinates of reference points
% 
%       qp: [3xNq] double array coordinates of query points
%
