%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% computePlusAndMinusDerivatives3D() computes the upwind Hamilton-Jacobi
...
function [phi_x_plus, phi_y_plus, phi_z_plus, ...
          phi_x_minus, phi_y_minus, phi_z_minus] = ...
         computePlusAndMinusDerivatives3D(phi, ...
                                          ghostcell_width, ...
                                          dX, ...
...
% parameter checks
if (nargin < 4)
  error('MATLAB:missingArgs','computePlusAndMinusDerivatives3D:missing arguments');
end
...
if (nargin < 5)
  ...
  if ( (spatial_derivative_order ~= 1) & (spatial_derivative_order ~= 2) ...
    ...
    error('computePlusAndMinusDerivatives3D:Invalid spatial derivative order...only 1, 2, 3, and 5 are supported');
  end
end
